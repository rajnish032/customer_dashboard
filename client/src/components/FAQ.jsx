...
const FAQ = () => {
    return (
        <div className="p-0 md:px-16 my-10 text-left lg:mx-10 mx-3 rounded-lg  ">
            ...
            <Accordion
                title={"Can I Register if i don't have any Surveying Software ?"}
                answer={"Yes, you are welcome. All just we want relevant surveying skills"}
            />
            <div className="bg-blue-500 h-[1px]"></div>
            <Accordion
                title="Do I need certifications to join ?"
                answer={`Not necessarily! If you have proven expertise in surveying, you’re welcome. `
                } />
            <div className="bg-blue-500 h-[1px]"></div>
